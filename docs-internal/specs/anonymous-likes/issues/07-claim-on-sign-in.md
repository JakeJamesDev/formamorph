...
- [ ] Codes for an Install whose account is known: `anonymous_likes_account_suspended` and `anonymous_likes_account_own_listing` are 403; `anonymous_likes_account_already_liked` is the 200. Ticket 03's Comments hold the final contract.
