# Exact summary-label system prompt

Rendered system message for the first case. Other request fields and the lookup tool were preserved; [protocol](summary-label-protocol.md).
