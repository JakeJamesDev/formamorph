...
> Formamorph is an open-ended AI roleplay engine. Stories are generated by **your chosen AI model** and worlds can be authored by **anyone**, so the content is effectively unbounded and may include explicit sexual and other adult material. The in-app world browser surfaces **user-created worlds provided as-is and *not moderated*** by this project. The few bundled example worlds are kept comparatively tame, but still carry mature themes (e.g. weight-gain). See [Disclaimer & responsible use](#disclaimer) before using.
...
- 🎭 **Character customization** — tweak a **3D VRM avatar** (body shape, hair, skin/eye color) that updates in real time
