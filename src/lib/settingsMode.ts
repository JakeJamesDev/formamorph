 ...
 *
 * Simple keeps everyday play reachable (appearance, scene, narration feel, the core turn toggles,
 * endpoint connection, all of Accessibility) and hides the tuning surfaces: the Prompts tab, the image
