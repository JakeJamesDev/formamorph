...
// <DrawerOverlay /> yourself when a dimming scrim is wanted.
const Drawer = ({
...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Description ref={ref} className={cn('text-helper text-muted-foreground', className)} {...props} />
));
