  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-helper text-muted-foreground">
        Organizes shared placeholders in the editor only. Groups are never sent to the AI, and a placeholder
        that belongs to an entity or dictionary stays under it.
      </p>
    </div>
  );
};
