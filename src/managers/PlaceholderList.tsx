...
import { Link2, ArrowUpFromLine, BookOpen, User } from 'lucide-react';
...
import { applyScopedPlaceholderDrop, placeholderTreeNodes, type PlaceholderTreeNode } from '@/lib/placeholderScopes';
 ...
 *
 * Over a world, the tree also draws an owner node for each entity or book that owns placeholders, with
 * that owner's rows beneath, and a drag across those sections moves the record between lists with its id
 * kept. Bound to one owner's section (an entity panel), it draws that owner's rows alone.
 *
