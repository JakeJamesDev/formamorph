...
function useProvideSettings() {
  ...
  const [continueChoiceEnabled, setContinueChoiceEnabled] = usePersistentState<boolean>(`${APP_ID}_continueChoiceEnabled`, DEFAULT_CONTINUE_CHOICE, boolCodec);
