# ADR-0008 — Tools live in prompt presets and go only to endpoints known to support them
...
- **A Tool is defined in a prompt preset**, not in a world. It shares and exports with the preset. A world author cannot ship a Tool.
